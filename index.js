...
//the internal variable is located inside of myFunction. 
//Since nestedFunction is also located inside myFunction, nestedFunction can use the internal variable
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(data){
    let arr = []
    data.forEach(animal => arr.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}` ))
    return arr
  }
  ...
  */
  ...
  function lowerCaseNames(data){
    let arr =[]
    data.map(animal => arr.push(animal.animal_name.toLowerCase()))
    return arr
  }
